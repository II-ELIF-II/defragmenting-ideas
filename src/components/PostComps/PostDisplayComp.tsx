      ...
      <div className="flex flex-col w-full items-center pt-3">
        <div className="flex justify-center w-full">
          <div className="w-full md:w-4/6 px-4 md:px-0 mx-2 my-1 z-10">
            <div className="w-fit tracking-widest bg-neutral-950/40 md:backdrop-blur-sm text-xl md:text-3xl px-3 py-2 -mt-18 font-semibold border-l-8 border-teal-500">
              <h1>
                <span className="text-teal-400 font-semibold inline">&#92;&gt; </span>
                {Post.title}
            ...
            {<main id="mainContent" className="animate-slideInBottom text-justify overflow-hidden pb-2 tracking-wider" dangerouslySetInnerHTML={{__html: Post.content}}/>}
            {isDevEnvironment() && (
