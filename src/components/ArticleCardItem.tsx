...
export function ArticleCardItem(article: ArticleProps) {
  return (<div onClick={() => setArticleState(true, article)} className="relative flex flex-col grow cursor-pointer group overflow-hidden min-h-screen lg:h-full snap-center lg:snap-align-none ease-in-out duration-500 hover:z-10 hover:shadow-xl hover:shadow-neutral-950/60">
    ...
    <div className="absolute bottom-0 flex flex-col w-full bg-gradient-to-r from-neutral-950/60 to-neutral-950/80 backdrop-blur-sm group-hover:backdrop-blur-md">
      ...
      <p className="flex grow text-md xl:text-lg mb-4 px-3 text-justify">{article.summary}</p>
