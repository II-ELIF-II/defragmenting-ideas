...
const PostCardHeaderComp = ({TextDate, TextTitle}: {TextDate?: string, TextTitle: string}) => {
  ...
  return(
    <div className="flex flex-col justify-around gap-3 mt-0 xl:mt-16 drop-shadow-lgCustom">
      <p className="w-fit mt-3 bg-teal-600 px-2 py-1 text-xl font-semibold tracking-wider">{elementDate}</p>
      <h2 className="w-fit text-2xl xl:text-3xl mr-8 px-3 py-2 bg-neutral-950/40 xl:backdrop-blur-sm font-semibold border-l-8 border-teal-600 tracking-widest">
