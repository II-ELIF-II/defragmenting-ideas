  ...
  return(
    <div className="sticky md:absolute top-0 w-full flex flex-col md:flex-row justify-evenly md:justify-between h-[12vh] lg:h-[6vh] items-center z-20 bg-neutral-950/80 md:bg-neutral-950/60 md:backdrop-blur pointer-events-auto">
      ...
      <div className="flex pr-4 [&>*]:ease-in-out [&>*]:duration-500">
        <button type="button" onClick={() => setOpenSearchModal(true)} className={((searchParams.size != 0) ? "rounded-l border-r-2 border-teal-400" : "rounded") + " py-1 pl-4 pr-6 flex justify-center items-center text-md bg-teal-600 hover:bg-teal-400 active:bg-teal-700"}>
