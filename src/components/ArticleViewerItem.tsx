      ...
      <div onClick={(e) => StopPropagation(e)} className="relative lg:mx-auto lg:my-24 w-full lg:w-[75vw] bg-neutral-200 h-fit z-10 outline-1 outline-offset-4 outline-dashed outline-neutral-50 shadow-2xl shadow-neutral-950/90">
        <div className="relative h-[60vh] w-full group overflow-hidden">
          ...
          <div className="absolute bottom-0 w-full bg-neutral-950/40 px-3 py-1">
            <h1 className="text-lg md:text-xl xl:text-2xl"><span className="text-teal-400 font-semibold">&#92;&gt; </span><span id="articleViewerTitle"></span></h1>
            <p id="articleViewerDate" className="text-md text-neutral-400 mt-1 whitespace-pre-wrap"></p>
          </div>
          <button onClick={() => setArticleState(false)} className="absolute top-0 right-0 text-md bg-teal-600 transition-all hover:bg-teal-400 active:bg-teal-700 flex items-center justify-center">
        ...
        <div className="relative flex grow min-h-[40vh] lg:min-h-full bg-gradient-to-b from-neutral-800 to-teal-950 border-t-2 border-teal-400">
          <p id="articleViewerContent" className="text-sm md:text-md xl:text-lg py-4 px-3 text-justify z-10"></p>
