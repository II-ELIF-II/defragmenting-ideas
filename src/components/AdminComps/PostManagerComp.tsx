...
const PostManagerComp = ({postResults, postQuery}: {postResults: adminPanelPostsParams, postQuery: string}) => {
  ...
  return(
    <div className="flex flex-col justify-between items-center grow">
      <div className="flex justify-center items-center grow w-full p-8">
        <div className="animate-slideInTop md:animate-slideInRight grow grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-8">
