...
const Post = async(Params: any) => {
  ...
  // let test = document.querySelector("embed")
  // console.log(test)

  return (
    <div className="flex w-screen min-h-screen overflow-y-hidden">
      <HeaderComp/>
          ...
          <div className="flex flex-col w-full items-center pt-3 ">
            <div className="flex flex-row w-full">
              ...
              <div className="w-4/6 mx-2 my-1 z-10">
                ...
                <main className="animate-slideInBottom text-justify" dangerouslySetInnerHTML={{__html: Content}}/>
                {isDevEnvironment() && (
